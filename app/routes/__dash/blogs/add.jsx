        ...
        <fieldset className="contents" disabled={isBusy}>
          ...
          <div className="flex flex-col items-stretch justify-start gap-2">
            ...
            <Slate editor={editor} value={initialValue}>
              <HoveringToolbar setState={setValue} />
              <Editable
...
const HoveringToolbar = ({ setState }) => {
  const ref = useRef();
...
const FormatButton = ({ format, icon }) => {
  ...
  return (
    ...
    >
      {icon === "format_bold" ? <FormatBold /> : null}
      {icon === "format_italic" ? <FormatItalic /> : null}
      {icon === "format_underlined" ? <FormatUnderlined /> : null}
    </div>
  );
};
