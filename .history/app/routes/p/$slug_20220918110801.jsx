...
import { getMerchsByAuthor } from "utils/merch.server";
import { createOrder } from "utils/payment.server";
import { getUserId } from "utils/session.server";
import { getSponsersByAuthor } from "utils/sponser.server";
...
export async function loader({ params, request }) {
  ...
  const sponsers = await getSponsersByAuthor(user);
  const merchs = await getMerchsByAuthor(user);
